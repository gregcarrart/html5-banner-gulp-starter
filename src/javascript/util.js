...
UTIL.cta = function(selector, options) {
    var w            = options.w,
        ...
        style        = options.style,
        color        = options.color ? (options.color.indexOf('#') > -1 ? options.color : '#'+options.color) : null,
        rollover     = options.rollover ? (options.rollover.indexOf('#') > -1 ? options.rollover : '#'+options.rollover) : null,
        textW        = options.textW,
        textH        = options.textH,
